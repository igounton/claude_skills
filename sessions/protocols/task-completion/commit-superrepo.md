...
4. {merge_instruction}
   ...
   ```markdown
   [DECISION: Merge Submodule to {default_branch}] Would you like to merge this submodule branch to {default_branch}?
...
5. {push_instruction}
   ...
   ```markdown
   [DECISION: Push Submodule to Remote] Would you like to push the submodule changes to remote?
...
4. {merge_instruction}
   ...
   ```markdown
   [DECISION: Merge to {default_branch}] Would you like to merge this branch to {default_branch}?
...
5. {push_instruction}
   ...
   ```markdown
   [DECISION: Push to Remote] Would you like to push the changes to remote?
