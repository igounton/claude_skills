...
/// ===== LOCAL ===== ///
const { editState, loadState, Mode, PROJECT_ROOT, loadConfig, findGitRepo, CCTools } = require("./shared_state.js");
///-///
...
if (repoPath) {
  try {
    ...
    const inTask =
      (STATE.current_task.submodules && STATE.current_task.submodules.includes(submoduleName)) ||
